        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 40, alignItems: 'center' }}>
            <div>
              ...
              <h2 style={{
                fontSize: 'clamp(28px, 4.5vw, 42px)', fontWeight: 900, letterSpacing: '-1px', marginBottom: 16,
                color: '#fff',
              }}>
                Become a HelplyAI Creator and earn <span style={{ color: '#fff', textDecoration: 'underline' }}>$600 - $4000+</span> per month.
              </h2>
              
              <div style={{ marginBottom: 24 }}>
                {[
                  { icon: '💰', text: 'Get paid for every video you post - even if you have never posted a video before.' },
                  { icon: '📈', text: 'Earn bonuses for every view your video gets (up to $2000+ per viral video).' },
                  { icon: '📚', text: 'Step-by-step instructions from us - we\'ve made 3,000+ videos with 500M+ views.' },
                  { icon: '🎯', text: 'Become a full-time content creator ($100k+ in total creator earnings).' },
                ].map((item, i) => (
                  <div key={i} style={{
                    display: 'flex',
            ...
            <div style={{
              ...
              {[
                { text: 'Caught my roommate using AI for her interview 😱', views: '2.4M', img: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=600&fit=crop' },
                { text: 'I have no hope for this generation', views: '1.8M', img: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=600&fit=crop' },
                { text: 'Best AI tool I\'ve used for interviews', views: '3.2M', img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=600&fit=crop' },
                { text: 'This changed my career 🚀', views: '1.5M', img: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=600&fit=crop' },
              ].map((video, i) => (
                <div key={i} style={{
                  background: `url(${video.img}) center/cover`,
                  borderRadius: 12,
                  padding: 16,
                  aspectRatio: '9/16',
                  display: 'flex',
