...
import { Database, Brain, BarChart, Code, CheckCircle } from 'lucide-react';

export default function DataSciencePage() {
  const topics = [
    { icon: Database, title: 'SQL & Data', desc: 'Complex queries, data manipulation, ETL processes' },
    { icon: Brain, title: 'Machine Learning', desc: 'Algorithms, model selection, feature engineering' },
    { icon: BarChart, title: 'Statistics', desc: 'Probability, hypothesis testing, A/B experiments' },
    { icon: Code, title: 'Coding', desc: 'Python, pandas, data structures, algorithms' },
  ];

  const tips = [
    'Practice SQL window functions and complex joins',
    'Know the bias-variance tradeoff and when to use which model',
    'Be ready to explain your past projects in detail',
    'Brush up on probability and statistics fundamentals',
    'Prepare to whiteboard ML system design',
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-16">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">Data Science Interview Prep</h1>
        <p className="text-xl text-gray-400 mb-12">Master SQL, machine learning, statistics, and coding for DS and ML engineer roles.</p>
        ...
        <div className="text-center p-8 bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl">
          <h2 className="text-2xl font-bold mb-4">Ready to ace your data science interview?</h2>
